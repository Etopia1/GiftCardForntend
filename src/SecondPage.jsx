...
const SecondPage = () => {
  ...
  return (
    <div className="w-full sm:h-[90vh] h-auto flex items-center justify-center p-4 bg-[#cad8e3]">
      <div className="w-full h-full flex flex-col-reverse sm:flex-row items-center justify-center gap-8">
        ...
        >
          <img
            src="https://i.pinimg.com/736x/c5/1a/f9/c51af9c54384f79166751cfe24abc79c.jpg"
            alt="Gift Card Team"
        ...
        <div
          ...
          data-aos="fade-up"
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-black flex items-center gap-2">
            <Users size={28} className="text-blue-700" />
            What do we do?
          </h2>
          <h1 className="text-xl sm:text-2xl text-black font-semibold leading-snug">
          ...
          <button
            className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-medium px-6 py-3 rounded-md shadow-md transition-all duration-300"
            data-aos="zoom-in"
          >
            <Info size={20} />
            KNOW MORE ABOUT US
